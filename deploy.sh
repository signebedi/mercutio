...
git log 0.9.0..0.9.1 --pretty=%B | grep ^Added >  .commits
git log 0.9.0..0.9.1 --pretty=%B | grep ^Changed >> .commits
git log 0.9.0..0.9.1 --pretty=%B | grep ^Fixed >> .commits
git log 0.9.0..0.9.1 --pretty=%B | grep ^Docs >> .commits
git log 0.9.0..0.9.1 --pretty=%B | grep ^Tests >> .commits
